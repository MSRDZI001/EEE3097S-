...
#  print("\nSense HAT Test Program ...\n")
  ...
  icm20948=ICM20948()
  i = 0
  print('Pitch','Roll','Yaw','AccX','AccY','AccZ','MagX','MagY','MagZ')
  while i < 100:
   ...
   # print("\r\n /-------------------------------------------------------------/ \r\n")
    print('%.2f,%.2f,%.2f,%d, %d, %d, %d, %d, %d' %(roll,pitch,yaw,Accel[0],Accel[1],Accel[2],Mag[0],Mag[1],Mag[2]))
    i += 1
   # print('\r\n Roll = %.2f , Pitch = %.2f , Yaw = %.2f\r\n'%(roll,pitch,yaw))
   # print('\r\n Acceleration:  X = %d , Y = %d , Z = %d\r\n'%(Accel[0],Accel[1],Accel[2]))  
   # print('\r\n Gyroscope:     X = %d , Y = %d , Z = %d\r\n'%(Gyro[0],Gyro[1],Gyro[2]))
   # print('\r\n Magnetic:      X = %d , Y = %d , Z = %d'%((Mag[0]),Mag[1],Mag[2]))
   # print('\r\n Temperature = %6.2f°C , Humidity = %6.2f%%' % (shtc3.SHTC3_Read_Temperature(), shtc3.SHTC3_Read_Humidity()))
